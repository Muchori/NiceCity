                ...
                try {
                    ...
                    if (!error) {
                        ...
                        if(Integer.parseInt(json_user.getString("verified")) == 1){
                            db.addUser(json_user.getString(KEY_UID), json_user.getString(KEY_FIRSTNAME), json_user.getString(KEY_SECONDNAME), json_user.getString(KEY_EMAIL), json_user.getString(KEY_AGE),
                                    json_user.getString(KEY_GENDER), json_user.getString(KEY_PHONENUMBER), json_user.getString(KEY_USERTYPE),json_user.getString(KEY_CREATED_AT));
                            Intent upanel = new Intent(MainActivity.this, ProfileActivity.class);
