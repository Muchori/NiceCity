...
import com.example.nicedigitalcity.helper.DatabaseHandler;
import com.example.nicedigitalcity.helper.Functions;
import com.example.nicedigitalcity.helper.SessionManager;
...
public class EmailVerify extends AppCompatActivity {
    ...
    private static String KEY_SECONDNAME = "second_name";
    private static String KEY_EMAIL = "email";
    private static String KEY_AGE = "age";
    private static String KEY_GENDER = "gender";
    private static String KEY_PHONENUMBER = "phone_number";
    private static String KEY_USERTYPE = "user_type";
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        db.addUser(json_user.getString(KEY_UID), json_user.getString(KEY_FIRSTNAME), json_user.getString(KEY_SECONDNAME), json_user.getString(KEY_EMAIL),
                                json_user.getString(KEY_AGE), json_user.getString(KEY_GENDER), json_user.getString(KEY_PHONENUMBER), json_user.getString(KEY_USERTYPE), json_user.getString(KEY_CREATED_AT));
                        session.setLogin(true);
                        Intent upanel = new Intent(EmailVerify.this, ViewBookingActivity.class);
